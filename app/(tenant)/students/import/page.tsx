export default function StudentsImportPage() {
  return (
    <div className="space-y-4">
      ...
      <form action="/api/students/import" method="post" encType="multipart/form-data" className="space-y-3 rounded border bg-surface p-4">
        ...
        />
        <p className="text-xs text-muted">Mapping JSON keys must be required field names; values are CSV column names.</p>

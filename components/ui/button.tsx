...
const variantClasses: Record<Variant, string> = {
  primary:
    "py-3 bg-primaryBtn text-white shadow-sm hover:bg-primaryBtnHover hover:shadow-md active:scale-[0.98] active:bg-primaryBtnActive",
  secondary: "py-2.5 border border-border bg-white text-text shadow-sm hover:bg-bg active:scale-[0.98]",
  ghost: "py-2.5 border border-transparent bg-transparent text-muted hover:bg-bg hover:text-text active:scale-[0.98]",
};
